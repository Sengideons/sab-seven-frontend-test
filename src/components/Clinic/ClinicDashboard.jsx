...
import ClinicSidebar from '../../scenes/global/ClinicSidebar';
import ClinicTopbar from '../../scenes/global/ClinicTopbar';
                ...
                <div class="container-fluid">
                    <div class="db-breadcrumb">
                        ...
                        <ul class="db-breadcrumb-list">
                            <li><a href="/clinic"><i class="fa fa-home"></i>Dashboard</a></li>
                            <li>Dashboard</li>
                        </ul>
                    </div>
